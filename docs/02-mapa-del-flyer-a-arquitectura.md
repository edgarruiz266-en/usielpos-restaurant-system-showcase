...
Vende control, velocidad y supervision; la arquitectura lo respalda con una combinacion de desktop, movil, API, base de datos central, auditoria y modulos especializados.
